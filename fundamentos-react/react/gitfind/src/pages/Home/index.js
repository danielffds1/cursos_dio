//index.js dentro da pasta Home/pages/src
...
function App() {
  ...
  // Irá armazenar o usuário que está logado no momento
  ...
  const handleGetData = async () => {
    ...
    if(newUser.name){
      ...
      setCurrent({avatar_url, name, bio, login});
    ...
    <div className="App">
      ...
      <div className="conteudo">
        ...
        <div className="info">
          ...
          {/* Validação mostrar apenas nas pesquisas */}
          {currentUser?.name ? (
            <>
